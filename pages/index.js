      ...
      <div className={styles.section}>
        ...
        <div className={styles.section3}>
          <div className={styles.somos}>
            ...
            <h4>
              Estamos comprometidos con la mejora continua de los procesos y de{" "}
              <br /> nuestri Sistema de Gestion Integral
            </h4>
          </div>
          <Link href="#">
            <button>CONTÁCTANOS</button>
        ...
        <div className={styles.content_right}>
          <div className={styles.content_right_text}>
            ...
            <p>
              ...
              mantenimiento en general y administración de residuos de manejo
              especial y peligrosos, conforme al marco regulatorio y
          ...
          <div className={styles.content_right_text}>
            ...
            <p>
              Ser la mejor opción en los servicios de limpieza, mantenimiento en
              general y administración de residuos, generando confianza a
              nuestros clientes.
            </p>
          </div>
          <div className={styles.content_right_text}>
      ...
      <div className={styles.clients}>
        <div className={styles.clients_inner}>
          ...
          <div className={styles.clients_img}>
            <Image alt="im1" src="/img/Content.png" width={1180} height={140} />
          </div>
        </div>
      </div>
